...
//
import { DIST } from 'react-static/lib/paths';
import { prepareRoutes } from 'react-static/lib/static';
import { DefaultDocument } from 'react-static/lib/RootComponents';
import { startDevServer } from 'react-static/lib/webpack';
import {
  findAvailablePort,
  getConfig,
  copyPublicFolder,
  createIndexFilePlaceholder,
} from 'react-static/lib/utils';
