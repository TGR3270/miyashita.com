...
import { Head, getSiteProps, getRouteProps } from 'react-static';
...
const PageMetadata = ({ site, page, location }) => {
  const href = `${site.root}${location.pathname}`;
...
export default withRouter(getSiteProps(getRouteProps(PageMetadata)));
